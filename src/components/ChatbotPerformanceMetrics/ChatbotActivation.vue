...
export default class ChatbotActivation extends Vue {
  @ChatbotPerformance.Getter('chatbotActivation') private data!: IChatbotPerformance;
}
</script>